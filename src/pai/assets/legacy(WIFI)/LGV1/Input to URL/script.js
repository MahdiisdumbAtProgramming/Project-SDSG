function activateCode() {
    ...
    const FRIENDS = "Luke, Adien, Henrik, Mathhew, Alex, Chadwick, Oscar & ETC";
    const NAME = "Mahdi (its a code same with Mahdiisdumb)";
    const TEST = "TEST";
    const urlMappings = {
        'OBJ': 'https://en.wikipedia.org/wiki/Cube',
        'CIPHER': 'https://cryptii.com/pipes/caesar-cipher',
        'BILLCIPHER': 'https://www.youtube.com/watch?v=cZdiFNhu31c',
        'BABYBILL': 'https://youtu.be/SB6UfeMt-xY',
        'BABYBILLCIPHER': 'https://youtu.be/SB6UfeMt-xY',
        'R': 'https://www.youtube.com/watch?v=BzNzgsAE4F0',
        'F': 'https://www.youtube.com/watch?v=fzvp0gLeUg0',
        'BILL': 'https://www.doritos.com',
        'DORITO': 'https://th.bing.com/th/id/OIP.bwnbSKHLW7WptcziSONt6AHaF3?rs=1&pid=ImgDetMain',
