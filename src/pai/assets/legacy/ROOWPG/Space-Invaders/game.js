...
function drawInvaders() {
    ...
    invaders.forEach((invader, index) => {
        ...
        if (invader.y > canvas.height) invaders.splice(index, 1); // Remove invaders that move off-screen
    });

    // Continuously add new invaders when the screen starts to clear
...
createInvaders(); // Initialize the invaders
