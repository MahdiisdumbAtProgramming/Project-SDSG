const __OBFUSCATED_CODE='PAPDMOBJ';window.Deobf=(function(){function _shiftChar(ch,shift){const c=ch.charCodeAt(0);if(c>=65&&c<=90){const base=65;return String.fromCharCode(((c-base+shift)%26+26)%26+base)}
